...
5. You will need to create a google maps api key and put that into the .env file for the map in the itinerary view to run.
4. cd into both the client and server folders again then run `npm start`.
